      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li><strong>Customization manifest:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code>, public grouped config, supported env vars, style presets, color themes, layouts, reusable component catalog, marketplace metadata, plugin manifests, theme packs, and theme hooks for self-hosters and plugins</li>
            ...
            <li><strong>Admin customization:</strong> <Link href="/admin/customization">/admin/customization</Link> is a tabbed env-first workbench for brand copy, logos, style presets, color themes, layout presets, feature flags, diagnostics, live preview panels, source badges, theme-pack validation, downloadable support reports, and copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code>, <code className="bg-surface-hover px-1 text-[12px]">.env.local</code>, Vercel, or Docker Compose values; <Link href="/admin/marketplace">/admin/marketplace</Link> filters the built-in catalog and shows catalog health</li>
          </ul>
        </div>
      </div>
