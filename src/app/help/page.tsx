      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li><strong>Deployment modes:</strong> omit <code className="bg-surface-hover px-1 text-[12px]">ARKIVEL_SITE_MODE</code> for the working wiki, or set it to <code className="bg-surface-hover px-1 text-[12px]">product</code> for the database-free product and documentation website</li>
            <li><strong>Single source repository:</strong> independent deployments can share the public Arkivel repository while keeping databases, storage, domains, and secrets isolated</li>
            ...
            <li><strong>Style preset:</strong> Set <code className="bg-surface-hover px-1 text-[12px]">NEXT_PUBLIC_ARKIVEL_STYLE</code> to <code className="bg-surface-hover px-1 text-[12px]">classic-wiki</code>, <code className="bg-surface-hover px-1 text-[12px]">atlas-modern</code>, or the monochrome lowercase <code className="bg-surface-hover px-1 text-[12px]">simplesque</code> skin, then rebuild/redeploy because <code className="bg-surface-hover px-1 text-[12px]">NEXT_PUBLIC_*</code> values are build-time config</li>
