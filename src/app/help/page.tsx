      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li><strong>Admin customization:</strong> <Link href="/admin/customization">/admin/customization</Link> previews the env-first contract, validates theme-pack JSON, and creates copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code> values; <Link href="/admin/marketplace">/admin/marketplace</Link> filters the built-in catalog and shows catalog health</li>
          </ul>
        </div>
      </div>
