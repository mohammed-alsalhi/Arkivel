      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li>The editor publishes reusable control metadata through <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code>, including primitive names, plugin extension points, block templates, and shortcut scopes</li>
            <li>Live collaboration publishes UX metadata through <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code>, including connection states, conflict/reconnect copy, notification routing, mobile QA, and accessibility checkpoints</li>
            <li>Multi-word queries use <strong>AND</strong> logic — every word must appear somewhere in the article</li>
              ...
              <li>Plugins, widgets, dashboards, and mobile clients can read <code className="bg-surface-hover px-1 text-[12px]">/api/search/contract</code> for stable typed result shapes and privacy metadata</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Assistant packs</strong> &mdash; <code className="bg-surface-hover px-1 text-[12px]">/api/assistant-packs</code>, <Link href="/admin/assistants">/admin/assistants</Link>, and <code className="bg-surface-hover px-1 text-[12px]">docs/assistant-packs.md</code> expose opt-in drafting, summarization, search, claim extraction, taxonomy, alt-text, import cleanup, and review packs with per-space availability, prompt/context previews, usage/cost metadata, permissions, safety notes, and fallback metadata for local/offline-friendly deployments.</li>
            <li><strong>Assistant governance</strong> &mdash; <code className="bg-surface-hover px-1 text-[12px]">/api/assistant-packs/governance</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/assistant-governance.md</code> publish privacy warnings, human-review requirements, citation prompts, confidence metadata, AI audit events, private/sensitive opt-outs, and the optional/non-blocking release gate.</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Discovery engines</strong> &mdash; <code className="bg-surface-hover px-1 text-[12px]">/api/discovery</code> reports duplicate pages, unresolved questions, canon conflicts, glossary gaps, orphan topics, topic clusters, and continue-reading opportunities.</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li><strong>Cache strategy:</strong> <Link href="/admin/cache">/admin/cache</Link>, invalidation rules, manual invalidation, stale warnings, Redis status, and deployment recipes</li>
            <li><strong>Offline/PWA:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/offline-pwa.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/offline/contract</code> cover install prompts, offline reading, stale indicators, retry queues, mobile QA, draft warnings, and privacy limits</li>
            <li><strong>Mobile polish:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/mobile-polish.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/mobile-polish</code> cover responsive QA, touch targets, safe areas, overflow/clipping checks, dialog bounds, and mobile help screenshot slots</li>
            <li><strong>Desktop research:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/desktop-app-research.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/desktop-research</code> cover local packaging tradeoffs, deployment recipes, filesystem import/export UX, and the research-only v5 decision</li>
            <li><strong>Accessibility finish:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/accessibility.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/accessibility</code> cover keyboard/focus/dialog/dropdown/control audits, widget summaries, contrast/motion checks, contribution guidance, and release blockers</li>
            <li><strong>Security review:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/security-review.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/security/review</code> cover browser headers, reviewed surfaces, abuse-case gates, supply-chain checks, and the pre-v5 threat-model draft</li>
            <li><strong>Privacy controls:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/privacy-controls.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/privacy/controls</code> cover deployment modes, retention defaults, user export/deletion planning, and warnings for AI, webhooks, exports, feeds, and indexing</li>
            <li><strong>Marketplace security:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/secure-marketplace-plugins.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/security</code> cover unsafe pack rejection, blocked permissions/hooks, dangerous plugin capabilities, provenance checks, and local-only installation</li>
            <li><strong>Marketplace beta:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-beta.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/beta</code> cover beta metrics, featured/recent/recommended packs, collections, compatibility badges, search facets, install-intent steps, and limitations</li>
            <li><strong>Marketplace lifecycle:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-lifecycle.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/lifecycle</code> cover pack states, transitions, local inventory, health checks, preview media validation, update metadata, compatibility warnings, and rollback guidance</li>
            <li><strong>Marketplace authoring:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-authoring.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/authoring</code> cover author dashboard metadata, README generation, checklist coverage, compatibility matrix output, quality expectations, and submission templates</li>
            <li><strong>Template marketplace:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/template-marketplace.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/templates</code> cover template-pack listings, included schema, category and article previews, compatibility notes, diff/merge contracts, and export-from-space fixture output</li>
            <li><strong>Sync manifests:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/sync-manifests.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/sync-manifests</code> cover source/target manifests, checksums, dry-run reports, signed snapshot plans, staging promotion checks, and the network-federation release gate</li>
            <li><strong>External references:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/external-references.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/external-references</code> cover imported/mirrored provenance labels, broken-reference diagnostics, and public index privacy planning</li>
            <li><strong>Archive mirrors:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/archive-mirror-workflows.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/archive-mirrors</code> cover read-only archive snapshots, private mirrors, selected-space transfers, repeated-sync conflict notes, and the pre-v5 federation decision checkpoint</li>
            <li><strong>Migration readiness:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/migration-readiness.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/migration-readiness</code> cover blocking migration dry runs, backup prompts, schema compatibility reports, restore validation, representative v4 upgrade paths, and failure recovery guidance</li>
            <li><strong>Backup and restore:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/backup-restore.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/backup-restore</code> cover admin backup wizard sections, restore rehearsal validation, scheduled backup planning, external storage notes, and disaster-recovery drill guidance</li>
            <li><strong>Upgrade assistant:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/v5-upgrade-planning.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/upgrade-assistant</code> cover v5 readiness checks, pre-upgrade diagnostics, post-upgrade smoke checks, compatibility warnings, and release-note/migration doc links</li>
            <li><strong>Test quality gates:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/test-quality-gates.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/test-quality</code> cover expanded test surfaces, stable QA fixtures, CI matrix planning, warning policy, and release-manager dashboard planning</li>
            <li><strong>E2E smoke suite:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/e2e-smoke-suite.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/e2e-smoke-suite</code>, and <code className="bg-surface-hover px-1 text-[12px]">e2e/smoke-suite.spec.ts</code> cover product smoke flows, responsive routes, fixture seeding, and failure screenshots/traces</li>
            <li><strong>Release gates:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/release-gate-automation.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/release-gates</code>, and <code className="bg-surface-hover px-1 text-[12px]">scripts/verify-docs-sync.mjs</code> cover release candidate gates, docs sync verification, checklist metadata, known issues, and blocker labels</li>
            <li><strong>Documentation onboarding:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/index.md</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/maintainer-guide.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">/api/documentation-onboarding</code> cover maintainer docs, setup paths, troubleshooting, docs IA, and practical link-test coverage</li>
            <li><strong>In-app onboarding:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/in-app-onboarding.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/in-app-onboarding</code>, and <code className="bg-surface-hover px-1 text-[12px]">examples/onboarding/demo-content-pack.json</code> cover first-run setup, guided admin onboarding, contextual help panel planning, demo content, and screenshot checkpoints</li>
            <li><strong>Example site recipes:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/example-site-recipes.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/example-site-recipes</code>, and <code className="bg-surface-hover px-1 text-[12px]">examples/recipes/site-recipes.json</code> cover setup recipes, env snippets, screenshot targets, pack recommendations, migration stories, and v5 readiness checks</li>
            <li><strong>Feature freeze:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/feature-freeze.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/release-freeze</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/known-issues.md</code> cover freeze policy, rehearsal matrix, blocker labels, v5 gate ownership, and release-note draft sections</li>
            <li><strong>Release candidate one:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/release-candidate-one.md</code>, <code className="bg-surface-hover px-1 text-[12px]">/api/release-candidate-one</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/rc-feedback-template.md</code> cover RC1 gates, deployment validation, starter/pack/import/export validation, review checklists, and feedback reporting</li>
            <li><strong>Final release gates:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/final-release-gates.md</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/final-release-gates</code> cover RC fixes, final beta freeze contracts, gate evidence, compatibility targets, correction windows, and stable v5 release gates</li>
            ...
            <li><strong>Import rehearsal:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/import/rehearsal</code> previews dry-run import reports with conflict categories, recommended actions, blocked changes, rollback plans, and fixture profiles. v4.81.2 rehearsals are intentionally no-write.</li>
            ...
            <li><strong>Role templates:</strong> <code className="bg-surface-hover px-1 text-[12px]">docs/role-templates.md</code> covers role templates, permission matrices, invitation resend/revoke audit events, API-key behavior, and self-host admin recovery.</li>
            ...
            <li><strong>Space templates:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/space-templates</code> returns built-in personal wiki, product docs, team handbook, worldbuilding bible, research notebook, reading archive, project knowledge base, and public documentation templates. <code className="bg-surface-hover px-1 text-[12px]">/space-templates/:id</code> previews each starter space, and <code className="bg-surface-hover px-1 text-[12px]">POST /api/space-templates</code> previews imported template JSON or a one-click local import preview for a <code className="bg-surface-hover px-1 text-[12px]">templateId</code> before any future apply flow; authoring notes live in <code className="bg-surface-hover px-1 text-[12px]">docs/space-templates.md</code>.</li>
            <li><strong>Domain workflows:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/space-workflows</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/domain-workflows.md</code> describe docs portal, team handbook, worldbuilding, research, and personal wiki workflow controls, steps, starter template links, and release gates.</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-0.5">
            ...
            <li><strong>Observability:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/admin/observability</code> and <code className="bg-surface-hover px-1 text-[12px]">/api/observability/metrics</code> provide structured event feed and metric ingestion data.</li>
            ...
            <li><strong>Cache:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/admin/cache</code> provides admin-only cache status, invalidation rules, stale warnings, and manual invalidation actions.</li>
            <li><strong>Offline/PWA:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/offline/contract</code> provides public install metadata, service-worker cache rules, stale indicators, retry queue limits, mobile QA checkpoints, draft warnings, and privacy limits.</li>
            <li><strong>Mobile polish:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/mobile-polish</code> provides responsive QA checkpoints, mobile regression checks, and screenshot slot metadata.</li>
            <li><strong>Accessibility finish:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/accessibility</code> provides accessibility audit surfaces, screen-reader summaries, contrast/motion checks, and v5 blocker metadata.</li>
            <li><strong>Security review:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/security/review</code> provides browser header metadata, reviewed security surfaces, abuse-case gates, dependency review checklist, and the pre-v5 threat-model draft.</li>
            <li><strong>Privacy controls:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/privacy/controls</code> provides deployment-mode controls, retention settings, user data export/deletion planning, and warnings for AI/external integrations.</li>
            <li><strong>Marketplace security:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/security</code> provides blocked permissions/hooks, dangerous plugin capability warnings, provenance requirements, and local-only installation guidance.</li>
            <li><strong>Marketplace beta:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/beta</code> provides beta metrics, featured/recent/recommended pack ids, collections, compatibility badges, search facets, install-intent steps, and limitations.</li>
            <li><strong>Marketplace lifecycle:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/lifecycle</code> provides pack states, allowed transitions, local inventory, health checks, preview media validation, update metadata, compatibility warnings, and rollback guidance.</li>
            <li><strong>Marketplace authoring:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/authoring</code> provides author dashboard sections, README/checklist generation metadata, compatibility matrix rows, docs completeness checks, and submission template references.</li>
            <li><strong>Template marketplace:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/templates</code> provides template-pack previews, included schema, compatibility notes, diff/merge contracts, and export-from-space fixture output.</li>
            <li><strong>Sync manifests:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/sync-manifests</code> provides source/target manifest metadata, section checksums, dry-run reports, signed snapshot planning, staging promotion guidance, and the network-federation release gate.</li>
            <li><strong>External references:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/external-references</code> provides cross-instance reference metadata, provenance labels, diagnostics, and privacy-safe public index planning.</li>
            <li><strong>Archive mirrors:</strong> <code className="bg-surface-hover px-1 text-[12px]">/api/archive-mirrors</code> provides read-only archive snapshot, private mirror, selected-space transfer, repeated-sync conflict, and federation decision metadata.</li>
          </ul>
        </div>
      </div>
