    ...
    <Page>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Editor control contract</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code> exposes reusable editor primitive metadata, plugin extension points, block templates, and shortcut scopes</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Search API contract</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/search/contract</code> publishes typed result shapes for articles, categories, tags, discussions, revisions, and marketplace items plus privacy, retention, and webhook planning metadata</li>
            ...
            <li><strong>Discovery engines</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/discovery</code> reports duplicate pages, unresolved questions, canon conflicts, glossary gaps, orphan topics, topic clusters, continue-reading modules, admin actions, and dashboard widgets</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>Assistant packs</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/assistant-packs</code>, <Link href="/admin/assistants">/admin/assistants</Link>, and <code className="bg-surface-hover px-1 text-[12px]">docs/assistant-packs.md</code> expose opt-in drafting, summarization, search, claim extraction, taxonomy, alt-text, import cleanup, and review packs with per-space availability, prompt/context previews, usage/cost metadata, permissions, safety, and fallback metadata</li>
            <li><strong>Assistant governance</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/assistant-packs/governance</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/assistant-governance.md</code> publish privacy warnings, human-review requirements, citation prompts, confidence metadata, AI audit events, private/sensitive opt-outs, and the optional/non-blocking release gate</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Observability</strong> — <Link href="/admin/observability">/admin/observability</Link>, <code className="bg-surface-hover px-1 text-[12px]">/api/admin/observability</code>, and <code className="bg-surface-hover px-1 text-[12px]">/api/observability/metrics</code> expose structured events, metric ingestion, privacy controls, and external collector guidance.</li>
            ...
            <li><strong>Cache strategy</strong> — <Link href="/admin/cache">/admin/cache</Link> and <code className="bg-surface-hover px-1 text-[12px]">/api/admin/cache</code> expose cache invalidation rules, manual invalidation, stale warnings, Redis status, and deployment recipes.</li>
            <li><strong>Offline/PWA</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/offline/contract</code>, <code className="bg-surface-hover px-1 text-[12px]">/sw.js</code>, and <code className="bg-surface-hover px-1 text-[12px]">/offline.html</code> define install prompts, offline reading caches, stale indicators, retry queues, mobile QA, draft warnings, and privacy limits.</li>
            <li><strong>Mobile polish</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/mobile-polish</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/mobile-polish.md</code> define responsive QA, 44px touch targets, safe-area checks, overflow/clipping guardrails, dialog bounds, and mobile help screenshot slots.</li>
            <li><strong>Desktop research</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/desktop-research</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/desktop-app-research.md</code> compare Electron, Tauri, browser PWA, and Docker Desktop options without committing desktop packaging to v5 scope.</li>
            <li><strong>Accessibility finish</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/accessibility</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/accessibility.md</code> define keyboard/focus/dialog/dropdown/control audits, widget summaries, contrast/motion checks, and v5 accessibility blockers.</li>
            <li><strong>Security review</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/security/review</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/security-review.md</code>, and middleware headers define reviewed surfaces, abuse-case gates, supply-chain checks, and the pre-v5 threat-model draft.</li>
            <li><strong>Privacy controls</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/privacy/controls</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/privacy-controls.md</code> define deployment-mode controls, retention settings, user export/deletion planning, and AI/external integration warnings.</li>
            <li><strong>Marketplace security</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/security</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/secure-marketplace-plugins.md</code> define unsafe pack rejection, blocked permissions/hooks, dangerous plugin capability warnings, provenance checks, and local-only installation guidance.</li>
            <li><strong>Marketplace beta</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/beta</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-beta.md</code> publish beta metrics, featured/recent/recommended packs, collections, compatibility badges, search facets, install-intent steps, and limitations.</li>
            <li><strong>Marketplace lifecycle</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/lifecycle</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-lifecycle.md</code> define pack states, transitions, inventory, health checks, preview media validation, update metadata, compatibility warnings, and rollback guidance.</li>
            <li><strong>Marketplace authoring</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/authoring</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/marketplace-authoring.md</code> define pack author dashboard metadata, README generator/checklist output, Arkivel compatibility matrix rows, author quality expectations, and submission templates.</li>
            <li><strong>Template marketplace</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/templates</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/template-marketplace.md</code> define template-pack listings, included schema, category and article previews, compatibility notes, diff/merge contracts, and export-from-space fixture output.</li>
            <li><strong>Sync manifests</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/sync-manifests</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/sync-manifests.md</code> define source/target manifests, checksums, dry-run reports, signed snapshot plans, staging promotion checks, and the network-federation release gate.</li>
            <li><strong>External references</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/external-references</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/external-references.md</code> define imported/mirrored provenance, diagnostics, and public index planning that excludes private content.</li>
            <li><strong>Archive mirrors</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/archive-mirrors</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/archive-mirror-workflows.md</code> define read-only archive snapshots, private mirror setup, selected-space transfers, repeated-sync conflict notes, and the pre-v5 federation decision checkpoint.</li>
            <li><strong>Migration readiness</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/migration-readiness</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/migration-readiness.md</code> define blocking migration dry runs, backup prompts, schema compatibility reports, restore validation, representative v4 upgrade paths, and failure recovery guidance.</li>
            <li><strong>Backup and restore</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/backup-restore</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/backup-restore.md</code> define admin backup wizard sections, restore rehearsal validation, scheduled backup planning, external storage notes, and disaster-recovery drill guidance.</li>
            <li><strong>Upgrade assistant</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/upgrade-assistant</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/v5-upgrade-planning.md</code> define v5 readiness checks, pre-upgrade diagnostics, post-upgrade smoke checks, compatibility warnings, and release-note/migration doc links.</li>
            <li><strong>Test quality gates</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/test-quality</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/test-quality-gates.md</code> define expanded test surfaces, stable QA fixtures, CI matrix planning, warning policy, and release-manager dashboard planning.</li>
            <li><strong>E2E smoke suite</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/e2e-smoke-suite</code>, <code className="bg-surface-hover px-1 text-[12px]">e2e/smoke-suite.spec.ts</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/e2e-smoke-suite.md</code> define product smoke flows, responsive routes, fixture seeding, and failure screenshots/traces.</li>
            <li><strong>Release gates</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/release-gates</code>, <code className="bg-surface-hover px-1 text-[12px]">scripts/verify-docs-sync.mjs</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/release-gate-automation.md</code> define release candidate gates, docs sync verification, checklist metadata, known issues, and blocker labels.</li>
            <li><strong>Documentation onboarding</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/documentation-onboarding</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/index.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/maintainer-guide.md</code> define maintainer docs, setup paths, troubleshooting, docs IA, and practical link-test coverage.</li>
            <li><strong>In-app onboarding</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/in-app-onboarding</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/in-app-onboarding.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">examples/onboarding/demo-content-pack.json</code> define first-run setup, guided admin topics, contextual help panels, demo content, and screenshot checkpoints.</li>
            <li><strong>Example site recipes</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/example-site-recipes</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/example-site-recipes.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">examples/recipes/site-recipes.json</code> define setup recipes, env snippets, screenshot targets, pack recommendations, migration stories, and v5 readiness checks.</li>
            <li><strong>Feature freeze</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/release-freeze</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/feature-freeze.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/known-issues.md</code> define freeze policy, rehearsal matrix, blocker labels, v5 gate ownership, and release-note draft sections.</li>
            <li><strong>Release candidate one</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/release-candidate-one</code>, <code className="bg-surface-hover px-1 text-[12px]">docs/release-candidate-one.md</code>, and <code className="bg-surface-hover px-1 text-[12px]">docs/rc-feedback-template.md</code> define RC1 gates, deployment validation, starter/pack/import/export validation, review checklists, and feedback template.</li>
            <li><strong>Final release gates</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/final-release-gates</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/final-release-gates.md</code> define RC fixes, final beta freeze contracts, gate evidence, compatibility targets, correction windows, and stable v5 release gates.</li>
            ...
            <li><strong>Customization manifest</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code> exposes grouped brand, style preset, color theme, layout, feature flag, limit, map, reusable component, editor control, collaboration UX, public API v1, SDK type, webhook reliability, operations dashboard, maintenance tooling, observability, performance budgets, cache strategy, offline/PWA, mobile polish, desktop research, accessibility finish, migration readiness, backup/restore, upgrade assistant, test quality gates, e2e smoke suite, release gate automation, documentation onboarding, in-app onboarding, example site recipes, feature freeze, release candidate one, final release gates, security review, privacy controls, marketplace security, marketplace beta, marketplace lifecycle, marketplace authoring, template marketplace, sync manifest, external reference, archive mirror, component slot, persisted space customization, marketplace registry/import-preview, plugin manifest schema/examples/compatibility matrix, plugin, theme-pack, template-pack, migration guidance, and theme-hook metadata for self-hosters, plugins, forks, and deployment dashboards.</li>
            ...
            <li><strong>Import rehearsal</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/import/rehearsal</code> exposes dry-run conflict categories, recommended actions, blocked changes, rollback plans, and fixture profiles for small wiki, large archive, docs portal, and worldbuilding atlas imports before any write-capable flow.</li>
            ...
            <li><strong>Role template contract</strong> — <code className="bg-surface-hover px-1 text-[12px]">docs/role-templates.md</code> documents role templates, API-key behavior, invitation expiration/resend/revoke actions, audit events, and admin recovery guidance.</li>
            ...
            <li><strong>Space templates</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/space-templates</code> exposes preview-safe personal wiki, product docs, team handbook, worldbuilding bible, research notebook, reading archive, project knowledge base, and public documentation templates, with preview pages, JSON validation, one-click local import previews, category trees, starter articles, sample metadata, tags, infobox fields, navigation, dashboards, layouts, and recommended packs.</li>
            <li><strong>Domain workflows</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/space-workflows</code> and <code className="bg-surface-hover px-1 text-[12px]">docs/domain-workflows.md</code> publish workflow controls, steps, starter template links, and release gates for docs portals, team handbooks, worldbuilding, research, and personal wiki products.</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Cache strategy</strong> — invalidation rules, manual invalidation, stale warnings, Redis status, and deployment recipes at <Link href="/admin/cache">/admin/cache</Link></li>
            <li><strong>Offline/PWA</strong> — install prompts, cached reading pages, stale indicators, retry queues, and mobile QA via <code className="bg-surface-hover px-1 text-[12px]">/api/offline/contract</code></li>
            <li><strong>Mobile polish</strong> — responsive QA, touch targets, safe areas, overflow checks, dialog bounds, and screenshot slots via <code className="bg-surface-hover px-1 text-[12px]">/api/mobile-polish</code></li>
            <li><strong>Accessibility finish</strong> — keyboard/focus audits, widget summaries, contrast/motion checks, and release blockers via <code className="bg-surface-hover px-1 text-[12px]">/api/accessibility</code></li>
            <li><strong>Security review</strong> — browser headers, review checklist, abuse cases, supply-chain gates, and threat model via <code className="bg-surface-hover px-1 text-[12px]">/api/security/review</code></li>
            <li><strong>Privacy controls</strong> — deployment modes, retention keys, user data lifecycle, and integration warnings via <code className="bg-surface-hover px-1 text-[12px]">/api/privacy/controls</code></li>
            <li><strong>Marketplace security</strong> — unsafe pack rejection, blocked hooks/permissions, dangerous warnings, and provenance checks via <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/security</code></li>
            <li><strong>Marketplace beta</strong> — landing metrics, featured/recent/recommended packs, collections, facets, install intent, and limitations via <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/beta</code></li>
            <li><strong>Marketplace lifecycle</strong> — pack states, transitions, inventory, health checks, preview media validation, and rollback guidance via <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/lifecycle</code></li>
            <li><strong>Marketplace authoring</strong> — pack validation, metadata preview, screenshot/license/docs checks, README generation, compatibility matrix, and submission templates via <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/authoring</code></li>
            <li><strong>Template marketplace</strong> — template-pack listings, previews, diff/merge metadata, and export-from-space fixture output via <code className="bg-surface-hover px-1 text-[12px]">/api/marketplace/templates</code></li>
            <li><strong>Sync manifests</strong> — dry-run space move reports, visibility rules, checksums, and signed snapshot plans via <code className="bg-surface-hover px-1 text-[12px]">/api/sync-manifests</code></li>
            <li><strong>External references</strong> — imported/mirrored provenance labels, broken-reference diagnostics, and public index privacy plans via <code className="bg-surface-hover px-1 text-[12px]">/api/external-references</code></li>
            <li><strong>Archive mirrors</strong> — read-only archive snapshot, private mirror, selected-space transfer, and conflict decision metadata via <code className="bg-surface-hover px-1 text-[12px]">/api/archive-mirrors</code></li>
