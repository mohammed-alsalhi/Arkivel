      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Customization Studio</strong> — <Link href="/admin/customization">/admin/customization</Link> is a tabbed env-first workbench for brand copy, logos, style, color theme, layout, feature flags, preview panels, source badges, theme-pack JSON validation, and copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code>, <code className="bg-surface-hover px-1 text-[12px]">.env.local</code>, Vercel, or Docker Compose output.</li>
