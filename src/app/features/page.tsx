      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Customization Studio</strong> — <Link href="/admin/customization">/admin/customization</Link> previews the env-first branding, style, color theme, layout, feature flag, and theme-pack contract with copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code> output.</li>
            <li><strong>Built-in Marketplace</strong> — <Link href="/admin/marketplace">/admin/marketplace</Link> lists styles, color themes, layouts, component packs, plugins, and theme packs without fetching remote code.</li>
