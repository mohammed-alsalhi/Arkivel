      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Customization Studio</strong> — <Link href="/admin/customization">/admin/customization</Link> previews the env-first branding, style, color theme, layout, feature flag, and theme-pack contract with selectable presets, theme-pack JSON validation, and copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code> output.</li>
