      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Product site mode</strong> — <code className="bg-surface-hover px-1 text-[12px]">ARKIVEL_SITE_MODE=product</code> replaces the database-backed wiki shell with the public Arkivel product homepage, <Link href="/docs">/docs</Link>, and the API reference; omission keeps wiki mode</li>
            <li><strong>Single-repo deployments</strong> — multiple isolated deployment projects can use the public Arkivel repository while retaining separate databases, storage, secrets, branding, and domains</li>
      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Style presets</strong> — <code className="bg-surface-hover px-1 text-[12px]">NEXT_PUBLIC_ARKIVEL_STYLE</code> switches between <code className="bg-surface-hover px-1 text-[12px]">classic-wiki</code>, <code className="bg-surface-hover px-1 text-[12px]">atlas-modern</code>, and the monochrome lowercase <code className="bg-surface-hover px-1 text-[12px]">simplesque</code> skin without changing route code.</li>
