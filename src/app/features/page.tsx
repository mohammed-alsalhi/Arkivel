      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Customization manifest</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code> exposes grouped brand, style preset, color theme, layout, feature flag, limit, map, reusable component, marketplace item, plugin, theme-pack, and theme-hook metadata for self-hosters, plugins, forks, and deployment dashboards.</li>
            ...
            <li><strong>Customization Studio</strong> — <Link href="/admin/customization">/admin/customization</Link> is a tabbed env-first workbench for brand copy, logos, style, color theme, layout, feature flags, diagnostics, preview panels, source badges, theme-pack JSON validation, downloadable support reports, and copy-ready <code className="bg-surface-hover px-1 text-[12px]">.env</code>, <code className="bg-surface-hover px-1 text-[12px]">.env.local</code>, Vercel, or Docker Compose output.</li>
            <li><strong>Built-in Marketplace</strong> — <Link href="/admin/marketplace">/admin/marketplace</Link> lists and filters styles, color themes, layouts, component packs, plugins, and theme packs with catalog health checks and no remote code fetching.</li>
