      ...
      <div className="wiki-portal mb-4">
        ...
        <div className="wiki-portal-body text-[13px]">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Customization manifest</strong> — <code className="bg-surface-hover px-1 text-[12px]">/api/customization</code> exposes grouped brand, style preset, color theme, layout, feature flag, limit, map, reusable component, marketplace registry/import-preview, plugin, theme-pack, and theme-hook metadata for self-hosters, plugins, forks, and deployment dashboards.</li>
            ...
            <li><strong>Built-in Marketplace</strong> — <Link href="/admin/marketplace">/admin/marketplace</Link> lists and filters styles, color themes, layouts, component packs, plugins, and theme packs with versioned local-registry health, schema/source metadata, license/checksum details, preview-only pack import parsing, theme token diffs, validation issue reporting, and no remote code fetching.</li>
