...
- **Style presets** — `NEXT_PUBLIC_ARKIVEL_STYLE` switches between `classic-wiki`, `atlas-modern`, and the monochrome lowercase `simplesque` skin without changing route code.
