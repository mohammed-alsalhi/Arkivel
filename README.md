...
- Tiptap rich text editor with slash commands, Markdown mode, syntax highlighting, collapsed-border tables, footnotes, images, captions, pull quotes, two-column blocks, accordions, vertical timelines, and auto-save.
