...
- **Canon Atlas:** `/atlas` turns published content into territories, story threads, continuity pressure, atlas moves, and a JSON feed at `/api/atlas`
- **Knowledge Command Center:** `/intelligence` combines 20 live quality, graph, canon, editorial, and audience signals with a graph constellation, readiness radar, impact simulator, and JSON feed at `/api/intelligence`
