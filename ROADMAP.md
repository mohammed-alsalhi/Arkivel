...
Arkivel 6.0.0 is the focused baseline; 6.1.0 added the command palette and per-user skin choice, 6.2.0 unified the page chrome and the folio sidebar, and 6.3.0 introduced migrations, per-deployment modules, the collections engine, and starter kits — the configurability model described in `docs/modules-and-collections.md`.
